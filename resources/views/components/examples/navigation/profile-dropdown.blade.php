                ...
                >
                    ...
                    <div>
                        <p class="font-bold text-xs text-gray-100">
                            {{--{{ $loggedInUser()->first_name }} {{ $loggedInUser()->last_name }}--}}Admin Adminson
                        </p>
                    </div>
                </div>
            </div>
    ...
    >
        <div class="bg-dark bg-opacity-80 rounded-b-md">
            <ul class="transition-opacity">
                <li class="menu-item menu-item-hoverable rounded-none px-2 py-1 h-8">
                ...
                <li class="menu-item-divider my-0 border-gray-500"></li>
                <li class="menu-item menu-item-hoverable rounded-t-none px-2 py-1 h-8">
                    <a class="flex h-full w-full px-2 gap-2 items-center text-gray-100 text-xs"
                       href="{{--{{ route('logout') }}--}}#">
                        <div class="header-nav-icon">
